...
public class Events extends textScroller{ //Events for different characters, text based adventure
    public void dwayneTheRockJohnson(){
        ...
        recursionText(0,"It's him. Dwayne the Rock Johnson, and he's currently raising his almighty eyeborw towards you.");
        ...
        if(sc.next().equals("a")){
            ...
            recursionText(0, "The Rock slams you to the ground and shoves protein pancaked in your face. You're hurt, but at least you got something.");
            player.subtractPlayerHealth();
    ...
    public void jonahWolk(){
        ...
        if(sc.next().equals("a")){
            if(player.getSecret()){
                ...
                recursionText(0,"You have nothing to show Jonah. He seems saddened and retreates back into the tall grass.");
                player.subtractPlayerScore();
            }
         recursionText(0, "");
        }
    ...
    public void tylerBlevins(){
        ...
        recursionText(0,"Suddenly, as quickly as is arose, the build begins to transform. The edits are too quick for your mind to perceive, but suddenly a window appears in front of you. It's the hit Fortnite gaming legend, Tyler Blevins.");
        ...
        if(sc.next().equals("a")){
            ...
            recursion(0,"You tell Tyler Blevins that Dr. Disrespect is better than him, and he simply laughs. He knows you're lying, it's so obvious. He doesn't even retaliate, he simply laughs his way back into the tall grass.");
        }
        else if(sc.next().equals("d")){
            int love = (int)(Math.random()*10+1);
            if(love == 2){
    ...
    public void backPackKid(){
        ...
        recursionText(0,"It's a melody, and a goofy ahh one at best. You immediately recognize the lack of skill or musical sense. It's the Backpack Kid.");
    ...
    public void mrBeast(){
        ...
        if(sc.next().equals("a")){
            recursionText(0, "You don't want to follow him, and instead as, 'Mr. Breast give me money'");
            recursionText(0, "Jimmy replies, saying 'Kil yourself'");
            player.subtractPlayerHealth();
            player.subtractPlayerScore();
        }
        else if(sc.next().equals("b")){
            recursionText("You follow him to a room with two monitors. Mr. Beast stands on one end, and you are motioned to stand on the other.");
            recursionText("Suddenly you hear, 'Seon Gi-hun vs. MR. BEAST! Begin!");
            recursionText("Welcome to your final test, I'm Mr. Beast. But we can scrap the S, cause' I've never missed a beat. You had to cut from honey under threat of a gun blast, but when I get a cut from honey, that's another check that I'm gonna ____");
            if(sc.next().equals("cash")){
            ...
            int love = (int)(Math.random()*10+1);
            if(love == 2){
                recursionText(0, "You convery your love of PewDiePie to Mr. Beast, and he reciprocates that love. You two have clearly established a bond, and a fulfilling one at that.");
                player.addPlayerHealth();
                player.addPlayerScore();
            }
            else{
